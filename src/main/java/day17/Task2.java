...
public class Task2 {
    public static void main(String[] args) {
        ChessPiece[][] chessBoardKramnikKasparov2000year = {
        ...
        ChessBoard matchKramnikKasparov2000year = new ChessBoard(chessBoardKramnikKasparov2000year);
        matchKramnikKasparov2000year.print();
